...
```
✅ Using OPENAI_API_KEY: sk-proj...
📨 Received message: Explain the concept of floor control in multi-agent systems.
🤖 Processing with GPT-4o...
💬 Agent response: Floor control in multi-agent systems refers to...
```
...
**Output:**
```
📨 Received message: Hello! What can you do?
🤖 Processing with Ollama...
💬 Agent response: I'm excited to help. As a helpful assistant...
```
...
**Output:**
```
💬 GPT-4o-mini Assistant: What is the capital of France?
🤖 GPT-4o-mini Assistant: The capital of France is Paris.

💬 GPT-4o Assistant: Based on that, what is a famous landmark in Paris?
🤖 GPT-4o Assistant: A famous landmark in Paris is the Eiffel Tower...
```
